...
wallclock_delphy_min = 14 + 22.737/60.0
wallclock_beast2_min = 2831 + 31.941/60.0

compare_logs(
    './delphy_outputs/ma_sars_cov_2_delphy.log', wallclock_delphy_min,
    'beast2_run/output.log', wallclock_beast2_min,
    'plots/ESSDelphyVsBeast2.pdf',
    burnin=0.30
)

wallclock_delphy_alpha_min = 18 + 44.314/60.0
wallclock_beast2_alpha_min = 6959 + 0.107/60.0

compare_logs(
    './delphy_outputs_alpha/ma_sars_cov_2_delphy_alpha.log', wallclock_delphy_alpha_min,
