...
wallclock_delphy_min = 52 + 29.759 / 60.0
wallclock_beast2_min = 145 + 47.071/60.0

compare_logs(
    './delphy_outputs/ebola_delphy.log', wallclock_delphy_min,
    'beast2_run/output.log', wallclock_beast2_min,
    'plots/ESSDelphyVsBeast2.pdf',
    burnin=0.30
)

wallclock_delphy_alpha_min = 61 + 52.171 / 60.0
wallclock_beast2_alpha_min = 188 + 40.471/60.0

compare_logs(
    './delphy_outputs_alpha/ebola_delphy_alpha.log', wallclock_delphy_alpha_min,
